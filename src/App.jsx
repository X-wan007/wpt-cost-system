...
export default function App() {
  ...
  const [companies, setCompanies] = useLocalState('wpt_companies', [
    { id: 'comp_default', logo: 'https://ui-avatars.com/api/?name=WPT&background=2563eb&color=fff&rounded=true', name: 'WPT ระบบรั้วสำเร็จรูป', address: '123 ถ.สุขุมวิท กรุงเทพฯ 10110', taxId: '0105555555555', phone: '02-123-4567', bankName: 'ธนาคารกสิกรไทย', accountNo: '123-4-56789-0', accountName: 'บจก. WPT รั้วสำเร็จรูป' }
  ]);
